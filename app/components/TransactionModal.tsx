      ...
      >
        ...
        >
          <Image
            ...
            priority
          />
          {transactionProgress?.image === "/images/txn_loading.png" ? (
            <Spinner />
          ) : null}
          {transactionProgress?.image === "/images/txn_failed.png" ? (
